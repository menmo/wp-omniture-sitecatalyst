...
function omni_admin() {
    ...
    if (omni_get_option('omni_enable_widgets')) {
        add_submenu_page('index.php', __('Omniture', 'omniture-sitecatalyst'), __('Omniture', 'omniture-sitecatalyst'), 'level_1', 'omniture-sitecatalyst/omniture.php', 'omni_reporting');
    }
...
function omni_reporting() {
    ...
    <div class=wrap>
        ...
        <table width="100%" cellspacing="2" cellpadding="5" class="editform">
            ...
            <tr>
                <th nowrap valign="top" width="100%" colspan="3">You many need to login with your normal SiteCatalyst
                    login credentials
                </th>
            </tr>
            <tr>
...
function omni_options() {
    ...
    if (isset($_POST['factory_settings'])) {
        ...
        ?>
        <div class="updated"><p>
            <strong><?php _e('Default settings restored, remember to set RSID ID', 'omni') ?></strong></p></div><?php
    }
        ...
        <fieldset class="options" name="general">
            ...
            <table width="100%" cellspacing="2" cellpadding="5" class="editform">
                ...
                <tr>
                    ...
                    <td><input name="omni_s_code_path" type="text" id="omni_s_code_path"
                               value="<?php echo omni_get_option('omni_s_code_path'); ?>" size="100"/>
                ...
                <tr>
                    ...
                    <td><input name="omni_url_campid" type="text" id="omni_url_campid"
                               value="<?php echo omni_get_option('omni_url_campid'); ?>" size="10"/>
                        <br/>Enter the url variable that will indentify campaigns. ( site.com/?campid=mycampcode Only
                        enter campid)
                    </td>
                </tr>
                <tr>
                    <th nowrap valign="top" width="33%" align="left"><?php _e('Track Admins', 'omni') ?></th>
                    <td><input name="omni_track_admins" type="checkbox" id="omni_track_admins"
                               value="true" <?php if (omni_get_option('omni_track_admins')) echo "checked"; ?>  />
                        <br/>Enable tracking of blog administrators.
                    </td>
                </tr>
                <tr>
                    <th nowrap valign="top" width="33%" align="left"><?php _e('Internal Search', 'omni') ?></th>
                    <td><input name="omni_track_internal_search" type="checkbox" id="omni_track_internal_search"
                               value="true" <?php if (omni_get_option('omni_track_internal_search')) echo "checked"; ?>  />
                        <br/>Enable tracking of internal seraches
                    </td>
                </tr>
                <tr>
                    <th nowrap valign="top" width="33%"
                        align="left"><?php _e('Internal Search: s.propN', 'omni') ?></th>
                    <td><input name="omni_sProp_internal_search" type="text" id="omni_sProp_internal_search"
                               value="<?php echo omni_get_option('omni_sProp_internal_search'); ?>" size="3"/>
                        <br/>Enter the s.prop # that will hold the Internal Search Terms (NOTE: only enter the # 1 or 2
                        or 3 etc.)
                    </td>
                </tr>
                <tr>
                    <th nowrap valign="top" width="33%" align="left"><?php _e('Internal Search Results', 'omni') ?></th>
                    <td><input name="omni_track_internal_search_num" type="checkbox" id="omni_track_internal_search_num"
                               value="true" <?php if (omni_get_option('omni_track_internal_search_num')) echo "checked"; ?>  />
                        <br/>Enable tracking of internal seraches results
                    </td>
                </tr>
                <tr>
                    <th nowrap valign="top" width="33%"
                        align="left"><?php _e('Internal Search Results: s.propN', 'omni') ?></th>
                    <td><input name="omni_sProp_internal_search_num" type="text" id="omni_sProp_internal_search_num"
                               value="<?php echo omni_get_option('omni_sProp_internal_search_num'); ?>" size="3"/>
                        <br/>Enter the s.prop # that will hold the Internal Search Results count (NOTE: only enter the #
                        1 or 2 or 3 etc.)
                    </td>
                </tr>
                <tr>
                    <th nowrap valign="top" width="33%" align="left"><?php _e('Logged In', 'omni') ?></th>
                    <td><input name="omni_track_loggedin" type="checkbox" id="omni_track_loggedin"
                               value="true" <?php if (omni_get_option('omni_track_loggedin')) echo "checked"; ?>  />
                        <br/>Enable tracking of logged in status of users
                    </td>
                </tr>
                <tr>
                    <th nowrap valign="top" width="33%" align="left"><?php _e('Logged In: s.propN', 'omni') ?></th>
                    <td><input name="omni_sProp_loggedin" type="text" id="omni_sProp_loggedin"
                               value="<?php echo omni_get_option('omni_sProp_loggedin'); ?>" size="3"/>
                        <br/>Enter the s.prop # that will hold the Logged In Status (NOTE: only enter the # 1 or 2 or 3
                        etc.)
                    </td>
                </tr>
                <tr>
                    <th nowrap valign="top" width="33%" align="left"><?php _e('Comments ', 'omni') ?></th>
                    <td><input name="omni_track_comments" type="checkbox" id="omni_track_comments"
                               value="true" <?php if (omni_get_option('omni_track_comments')) echo "checked"; ?>  />
                ...
                <tr>
                    ...
                    <td><input name="omni_event_comments" type="text" id="omni_event_comments"
                               value="<?php echo omni_get_option('omni_event_comments'); ?>" size="3"/>
                        <br/>Enter the event # that will capture the comment event(NOTE: only enter the # 1 or 2 or 3
                        etc.)
                    </td>
                </tr>
                <tr>
                    <th nowrap valign="top" width="33%"
                        align="left"><?php _e('Enabled Reporting Widgets ', 'omni') ?></th>
                    <td><input name="omni_enable_widgets" type="checkbox" id="omni_enable_widgets"
                               value="true" <?php if (omni_get_option('omni_enable_widgets')) echo "checked"; ?>  />
                        <br/>Enable Reporting Widgets
                    </td>
                </tr>
                <tr>
                    <th nowrap valign="top" width="33%" align="left"><?php _e('# Of Widgets', 'omni') ?></th>
                    <td><input name="omni_widget_number" type="text" id="omni_widget_number"
                               value="<?php echo omni_get_option('omni_widget_number'); ?>" size="3"/>
                        <br/>Enter the # of rows of reporting widgets to include: (Max of 3 rows. 3 widgets per row).
                        The Omniture SiteCatalyst Widget can only access reportlets created within SiteCatalyst and
                        saved to a dashboard.
                    </td>
                </tr>
                <tr>
                    <th nowrap valign="top" width="33%" align="left"><?php _e('JS Widget Path', 'omni') ?></th>
                    <td><input name="omni_widget_js_path" type="text" id="omni_widget_js_path"
                               value="<?php echo omni_get_option('omni_widget_js_path'); ?>" size="100"/>
                        <br/>Enter the path to the SiteCatalyst Widget file (ie.
                        https://sc.omniture.com/p/widget/current/js/widget.js ).
                    </td>
                </tr>
                <tr>
                    <th nowrap valign="top" width="33%"
                        align="left"><?php _e('Add Widget To Dashboard ', 'omni') ?></th>
                    <td><input name="omni_enable_dashboard_widget" type="checkbox" id="omni_enable_dashboard_widget"
                               value="true" <?php if (omni_get_option('omni_enable_dashboard_widget')) echo "checked"; ?>  />
...
function omni_get_tracker() {
    ...
    if (is_home() || is_front_page()) {
        $pageName = $category = $pageType = 'Frontpage';
    } elseif (is_page()) {
